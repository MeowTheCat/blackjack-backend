...
delete from raw where brand in ('Motherhood Maternity','A Pea In The Pod');
...
delete from raw where sale_price/retail_price > 0.4 and primary_category = 'shoes';

delete from raw where sale_price/retail_price > 0.3 and attribute_2 = 'top';
delete from raw where sale_price/retail_price > 0.6 and attribute_2 = 'suit';
